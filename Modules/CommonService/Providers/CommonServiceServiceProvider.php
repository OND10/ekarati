...
namespace Modules\CommonService\Providers;
...
class CommonServiceServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CommonService';

    protected string $nameLower = 'commonservice';
