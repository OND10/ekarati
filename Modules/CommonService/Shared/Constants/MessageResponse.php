...
namespace  Modules\CommonService\Shared\Constants;
...
class MessageResponse
{
    ...
    const DELETED_SUCCESSFULLY = 'Record trashed successfully';
    ...
    const USER_NOT_ACTIVATED = "User is inactive";
    ...
    const INVALID_TOKEN = "Invalid or expired refresh token";
